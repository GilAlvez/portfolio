...
const WorkCard = ({ link }: WorkCardProps) => {
	return (
			...
			<Link href={link}>
				...
				<div className="py-4 px-2 hidden group-hover:block">
					<p className="line-clamp-2 mb-2">
						Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus et dolorum quo earum
						distinctio reiciendis itaque placeat quis ex quasi aperiam, fuga ratione iusto, laboriosam
