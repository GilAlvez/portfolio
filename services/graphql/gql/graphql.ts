...
export type OwnerSeoQuery = { __typename?: 'Query', owners: Array<{ __typename?: 'Owner', seo: { __typename?: 'Seo', title: string, description: string, image: string, keywords: string } }> };
